...
while (not(do_calibration)):
    ...
    if ((retR) and (retL)):
        ...
        save_my_img(chessboard_pattern_detections_paired, "/media/AC10-0657/images/Set_3/Left", frameL)

        save_my_img(chessboard_pattern_detections_paired, "/media/AC10-0657/images/Set_3/Right", frameR)  
